        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(getContext(), "Circle Wins!", Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    Toast.makeText(getContext(), "Cross Wins!", Toast.LENGTH_SHORT).show();
                    break;
                case 3:
                    Toast.makeText(getContext(), "Match Drawn!", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
